...
class SlideShow(models.Model):
    trackid = models.CharField(max_length=20, verbose_name='测试')
    name = models.CharField(max_length=20, verbose_name="轮播图名字")
    img = models.CharField(max_length=150, null=True, verbose_name="轮播图图片")
    sort = models.CharField(max_length=20, null=True, verbose_name="图片顺序")
    class Meta:
        db_table = "slideshows"
        ordering = ['sort']
        verbose_name=("轮播图表")
...
class CategorieGroup(models.Model):
    categorieId = models.CharField(max_length=20, primary_key=True)
