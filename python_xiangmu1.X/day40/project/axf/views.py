...
from axf.models import SlideShow, MainDescription, Product, CategorieGroup, ChildGroup,User,Cart,Order,Address
import random
...
def home(request):
    ...
    return render(request, "home/home.html",
                  {"slideList":slideList,"mainList":mainList})
...
def changecart(request,flag):
    ...
    try:
        print(str(tokenValue)+","+str(gid)+","+str(cid)+","+str(pid))
...
def login(request):
    if request.method == "GET":
        if request.is_ajax():
            ...
            print("***************", rand_str)
            response = JsonResponse({"data":"ok","test":"aa"})
